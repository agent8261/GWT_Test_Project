...
public class CellTreeExample implements EntryPoint
{
  ...
  private static class Playlist
  {
    ...
    /**
     * Return the list of songs in the play-list.
     */
  ...
  private static class CustomTreeModel implements TreeViewModel
  {
    ...
    public <T> NodeInfo<?> getNodeInfo(T value)
    {
      if( value == null )
      {
        ...
        ListDataProvider<Composer> dataProvider = new ListDataProvider<CellTreeExample.Composer>(
            composers);
 ...
 // Create a tree with a few items in it.
  ...
  public void lonModuleLoad()
  {
    ...
    // Open the first play-list by default.
